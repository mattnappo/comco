#ifndef COMCO_PASSES_H
#define COMCO_PASSES_H
...
std::unique_ptr<mlir::Pass> createLowerMatmulPass();
std::unique_ptr<mlir::Pass> createLowerBufferPass();
std::unique_ptr<mlir::Pass> createOutlineAllReducePass();
std::unique_ptr<mlir::Pass> createLowerAllReducePass();
std::unique_ptr<mlir::Pass> createLauncherPass();
std::unique_ptr<mlir::Pass> createFusionPass();

//===- AllReduceLowering- Implementation of all-reduce lowering ------===//
//
...
//===----------------------------------------------------------------------===//
//
// This section implements in-dialect lowering of the all-reduce op to a block
